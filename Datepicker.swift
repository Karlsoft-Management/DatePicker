...
struct DatePicker: View {
    ...
    @Binding var date: time
    
    var body: some View {
        
            
            ZStack {
                CircularSlider(currentValue: $date.day, minValue: 1, maxValue: 31, knobRadius: 10, knobColor: .yellow, radius: 100, progressLineColor: .gray, trackColor: .gray, lineWidth: 2, backgroundColor: dotcolor, backgroundRadius: 15, currentValuePrefix: "", currentValueSuffix: "")
                CircularSlider(currentValue: $date.month, minValue: 1, maxValue: 12, knobRadius: 10, knobColor: .orange, radius: 75, progressLineColor: .gray, trackColor: .gray, lineWidth: 2, backgroundColor: dotcolor, backgroundRadius: 15, currentValuePrefix: "", currentValueSuffix: "")
                CircularSlider(currentValue: $date.year, minValue: 1900, maxValue: Double(Calendar.current.component(.year, from: Date())), knobRadius: 10, knobColor: .gray, radius: 50, progressLineColor: .gray, trackColor: .gray, lineWidth: 2, backgroundColor: dotcolor, backgroundRadius: 15, currentValuePrefix: "", currentValueSuffix: "")
